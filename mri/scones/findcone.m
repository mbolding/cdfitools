...
% TS -  Sampling period in seconds, gradient dwell time
% OS -  Oversampling Rate, ADC multiple of gradient dwell
...
if (nargin<6)
        TS = 0.000010; % 10 us for Allegra
end
if (nargin<7)
	OS = 1;
end
if (nargin<8)
        SMAX = 40000; % for Allegra 400mT/(m*ms)
end
if (nargin<9)
        GMAX = 4.0; % for Allegra 40mT/m
end
if (nargin<10)
	DCF = 0.0;
end
